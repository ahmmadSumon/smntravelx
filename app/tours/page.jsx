...
const Tours = () => {
  ...
  return (
    <div className="bg-black  py-20 z-30 w-full px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className=" text-4xl font-extrabold text-white text-center mb-12 relative">
          <span className="pt-2 bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-orange-500">
