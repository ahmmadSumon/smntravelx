...
const Packages = () => {
  ...
  return (
    <div className="bg-[#18181B] z-50 #18181B py-16 px-4 sm:px-6 lg:px-8">
      <section className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-xl text-blue-200">Discover the world's most popular destinations</p>
        </div>
              ...
              <div className="relative w-full h-80 rounded-t-2xl overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4">
                  ...
                  <div className="flex items-center mt-1">
                    ...
                    <p className="text-sm text-blue-200">{locationName}, {location}</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
